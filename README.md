...
```
cd existing_repo
git remote add origin https://gitlab.grainchain.io/grainchain-crm/gc-crm-routes-guard-lib.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.grainchain.io/grainchain-crm/gc-crm-routes-guard-lib/-/settings/integrations)
...
>>>>>>> d930d6b8f2006400ad46ec895a2fc500b150f8eb
